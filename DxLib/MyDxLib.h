...
namespace DxLib {
	...
	inline VECTOR&	operator *	(const VECTOR& in, const float scale)	{	return VScale(in, scale);			}
	inline VECTOR&	operator *= (VECTOR& in , const float scale)		{	return (in = VScale(in, scale));	}
	inline VECTOR&	operator *	(const VECTOR& in1 , const VECTOR& in2)	{	return VGet(in1.x * in2.x, in1.y * in2.y, in1.z * in2.z);		  }
	inline VECTOR&	operator *=	(VECTOR& in1, const VECTOR& in2)		{	return (in1 = VGet(in1.x * in2.x, in1.y * in2.y, in1.z * in2.z)); }
};