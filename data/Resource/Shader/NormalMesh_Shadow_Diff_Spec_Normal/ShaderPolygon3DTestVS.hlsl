...
VS_OUTPUT main(VS_INPUT VSInput)
{
	...
	float4 lightViewPos = mul(g_lightMatrix.viewMatrix, worldPosition);
	VSOutput.spos = mul(g_lightMatrix.projectionMatrix, lightViewPos);
	VSOutput.spos.z = lightViewPos.z;

	//VSOutput.spos = lightViewPos;
	// 出力パラメータセット ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++( 終了 )
